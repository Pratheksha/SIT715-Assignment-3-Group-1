<!-- Add PhotoOp	Created by Group 1 - SIT715 Assignment3-->
<div class="page-title">

	<div class="title-env">
		<h1 class="title">Add PhotoOp</h1>
		<p class="description">Add your own PhotoOp</p>
	</div>

	<div class="breadcrumb-env">

		<ol class="breadcrumb bc-1">
			<li><a href="/events/index"><i class="fa-home"></i>All PhotoOps</a></li>

			<li class="active"><strong>Add PhotoOp</strong></li>
		</ol>
		...
		<div class="panel-body">
			...
			<div class="member-form-add-header">
				<div class="row">
						...
						<div class="action-buttons">
							...
							<button type="reset" class="btn btn-block btn-gray">Cancel
							</button>
						</div>
			...
			<div class="member-form-inputs">
				...
				<div class="row">
					...
					<div class="col-sm-1">
						<label class="control-label" for="select_region">From Date</label>
					</div>
					<div class="col-sm-2">
					...
					<div class="col-sm-1">
						<label class="control-label" for="select_store">To Date</label>
					</div>
					<div class="col-sm-2">
						<div class="input-group">
							<input type="text" class="datepicker form-control"
				...
				<div class="row" id="fileRow">
					<div class="col-sm-3 text-center">
						...
						<div id="advancedDropzone" class="droppable-area">Upload photos here</div>
						...
						<table class="table table-bordered table-striped fileTable"
							...
							<thead>
								<tr>
									...
									<th width="4%" class="dsds" style="display: none;">#</th>
