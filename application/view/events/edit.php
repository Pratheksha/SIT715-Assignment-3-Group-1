	<!-- Add Comment	Created by Group 1 - SIT715 Assignment3-->
<style>
.loginWrong {
	color: #E81D02;
}
...
<div class="page-title">
	...
	<div class="title-env">
		<h1 class="title">PhotoOp Comment</h1>
		<p class="description">Notes about this Photo Opportunity </p>
	</div>

	<div class="breadcrumb-env">

		<ol class="breadcrumb bc-1">
			<li><a href="/events/index"><i class="fa-home"></i>PhotoOps</a></li>

			<li class="active"><strong>PhotoOp Comments</strong></li>
		</ol>
	...
	<div class="panel-body">
		<div class="member-form-inputs">
			...
			<div class="row" style="margin-top: 5px;">
				...
				<div class="col-sm-4">
					<label class="control-label"><strong>Location:</strong> <?php echo $event->address;?></label>
				</div>
				<div class="col-sm-4">
			...
			<div class="row" style="margin-top: 5px;">
				...
				<div class="col-sm-4">
					...
					<img src="<?php echo  URL_UPLOADS.$photo['file_name']?>"
						style="width: 200px; height:200px;padding-top:20px;">
				</div><?php }?>
