	<!-- Home page	Created by Group 1 - SIT715 Assignment3-->
<div class="page-title">

	<div class="title-env">
		<h1 class="title">PhotoOps</h1>
		<p class="description">Complete one or more search fields for photoOps</p>
	...
	<div class="breadcrumb-env">
		...
		<ol class="breadcrumb bc-1">
			<li><a href="#"><i class="fa-home"></i>PhotoOps</a></li>

		</ol>
		<a href="/events/add" class="btn btn-blue btn-lg">Add PhotoOp</a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<ul class="list-unstyled line-height-default">
							<li><u><a href="#">Check Weather Condition</a></u><span
								class=""></span></li>
						</ul>
